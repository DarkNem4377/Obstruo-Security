...
> (**v1.0.3**) is **[available for download](https://github.com/DarkNem4377/Obstruo-Security/releases/latest)**
...
**Current version: [v1.0.3](https://github.com/DarkNem4377/Obstruo-Security/releases/latest) — development complete, now in testing and debugging.**
